...
class EnhancedDataPreprocessor:
    ...
    def create_enhanced_combined_text(self, row: pd.Series) -> str:
        """
        Enhanced text combination with spatial and contextual features
        """
        # Basic text fields
        ...
        # Combine with enhanced special tokens
        combined = f"[TITLE] {title} [ABSTRACT] {abstract} [KEYWORDS] {keywords} [SPATIAL] {spatial_themes} [ZONES] {management_zones} [AREAS] {monitoring_areas} [OBJECTIVES] {objectives_text}"
    ...
    def prepare_multi_target_data(self, df: pd.DataFrame) -> Tuple[pd.DataFrame, Dict]:
        ...
        print("   Creating enhanced combined text...")
        ...
        print("   Creating binary label matrices...")
        ...
        print(f"   Enhanced text created for all papers")
...
def preprocess_dataset_for_training(df: pd.DataFrame) -> Tuple[pd.DataFrame, Dict, Dict, Dict]:
    ...
    print("Enhanced Multi-Target Data Preprocessing Pipeline")
    print("======================================================================")
    ...
    analysis_results = {
        ...
        'preprocessing_version': 'enhanced_multi_target'
    }
    ...
    print(f"   Enhanced text with spatial features created")
...
def demonstrate_preprocessing():
    ...
    print("Enhanced Data Preprocessing Demo")
    print("=" * 70)
    ...
    try:
        ...
        required_tokens = ['[TITLE]', '[ABSTRACT]', '[KEYWORDS]', '[SPATIAL]', '[ZONES]', '[AREAS]', '[OBJECTIVES]']
...
if __name__ == "__main__":
    # Run demonstration of preprocessing
